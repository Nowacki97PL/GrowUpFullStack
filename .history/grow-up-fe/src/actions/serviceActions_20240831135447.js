...
export const bookTrainingSession = (sessionData) => async (dispatch, getState) => {
    try {
        dispatch({ type: BOOK_SESSION_REQUEST });
        ...
        const { data } = await axios.post('/api/sessions/book/', sessionData, config);
