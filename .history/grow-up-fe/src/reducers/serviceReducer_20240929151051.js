...
export const sessionListReducers = (state = { sessions: [] }, action) => { // Upewnij się, że używasz `sessions`
    switch (action.type) {
        case SESSION_LIST_REQUEST:
            return { loading: true, sessions: [] }; // Upewnij się, że jest `sessions`

        case SESSION_LIST_SUCCESS:
            return {
                loading: false,
                sessions: action.payload, // Upewnij się, że jest `sessions`
            };
