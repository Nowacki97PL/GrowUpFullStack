...
import BookTrainingSessionScreen from "./screens/BookTrainingSession";
import TrainingSessionListScreen from "./screens/TrainingSessionList";
			...
			<main className="py-5">
				<Container>
					<Routes>
						...
						<Route path="/book-session" element={<BookTrainingSessionScreen />}></Route>
						...
						<Route
							...
							element={<TrainingSessionListScreen/>}
						></Route>
						<Route
