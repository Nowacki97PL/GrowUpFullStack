...
function UserEditScreen() {
    ...
    // Sprawdź, czy userUpdate jest zdefiniowane, zanim spróbujesz destrukturyzować jego właściwości
    if (!userUpdate) {
    // Renderuj komponent, który obsługuje przypadek, gdy userUpdate jest niezdefiniowane
        return <Loader />;
}
	const {
		error: errorUpdate,
