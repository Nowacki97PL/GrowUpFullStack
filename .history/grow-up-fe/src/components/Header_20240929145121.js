					...
					<Nav className="ms-md-auto me-xl-5">
						...
						{userInfo ? (
							<NavDropdown title={userInfo.name} id="username">
								...
								<LinkContainer to="/book-session">
									<NavDropdown.Item>Umów trening</NavDropdown.Item>
								</LinkContainer>
						...
						{userInfo && userInfo.isAdmin && (
							<NavDropdown title="Admin" id="admin-menu">
								...
								<LinkContainer to="/admin/session-list">
									<NavDropdown.Item>
										<i className="fa-brands fa-product-hunt"></i>
										Produkty
									</NavDropdown.Item>
								...
								<LinkContainer to="/trainer">
									<NavDropdown.Item>Trenerzy</NavDropdown.Item>
								</LinkContainer>
							</NavDropdown>
						)}
					</Nav>
